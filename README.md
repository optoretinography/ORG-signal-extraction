...
2. **example_data** (will be downloaded when running ORG_signal_extraction.m):
   ...
   - Timing: pre-stimulus time was 10.04 ms (~100 frames), the interval between ajacent flashes was 100 ms.
...
4. Output
   - The ORG signal will be saved in the "figure" folder within the dataset directory.
